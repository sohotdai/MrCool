class Admin::PatientsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @patient.save
        format.html { redirect_to admin_patient_path(@patient), notice: 'Patient was successfully created.' }
  ...
  private
    ...
    def patient_params
      params.require(:patient).permit(:first_name, :middle_name, :last_name, :year, :month, :day, :gender, :status, :location_id, :description)
    end
end
